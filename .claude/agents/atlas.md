...
tools: Read, Grep, Glob, Bash(rg:*), Bash(git log:*), Bash(git show:*), mcp__atlas-aci__view_file, mcp__atlas-aci__list_dir, mcp__atlas-aci__search_text, mcp__atlas-aci__search_symbol, mcp__atlas-aci__graph_query, mcp__atlas-aci__test_dry_run, mcp__atlas-aci__memex_read
methodology: ATLAS
methodology_version: "1.0"
role: Explorer/Scout — read-only codebase intelligence
handoffs: [spectra, apivr]
x-eidolons-mcp-wired: [atlas-aci, junction]
---
